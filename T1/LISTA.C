...
/***** Protótipos das funções encapuladas no módulo *****/
   ...
   static tpElemLista * CriarElemento( LIS_tppLista pLista , char valor ) ;
...
*     Elimina o espaço apontados pelo elemento.
*
***********************************************************************/
...
***********************************************************************/
   ...
   tpElemLista * CriarElemento( LIS_tppLista pLista , char valor )
   {
